          ...
          <div class="absolute right-0 z-20 w-full px-5 mt-16 transition" :class="{
            ...
            <ul class="flex flex-col bg-gray-100 w-full rounded shadow-md overflow-hidden">
              <li class="flex bg-gray-800">
                <h3 class="flex flex-1 text-white text-base font-semibold px-5 py-4">
                  Navigation
                </h3>
              </li>
              <li v-if="userLoggedIn">
                <router-link :to="{ name: 'scanner-page' }">
                  <a class="flex flex-1 text-base text-gray-700 hover:bg-gray-200 font-semibold px-8 py-3" href="#">
                    Tukar Botol
                  </a>
                </router-link>
              </li>
              ...
              <li v-if="!userLoggedIn">
                <a class="flex flex-1 text-lg text-gray-700 bg-gray-300 hover:text-blue-600 font-semibold px-8 py-4"
              ...
              <template v-else>
                <li>
                  <a class="flex flex-1 text-lg bg-gray-300 hover:text-blue-600 font-semibold px-8 py-4" href="#"
